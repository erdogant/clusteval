...
If desired, install ``clusteval`` from an isolated Python environment using conda:
...
Note that the removal of the environment will also remove the ``clusteval`` installation.
